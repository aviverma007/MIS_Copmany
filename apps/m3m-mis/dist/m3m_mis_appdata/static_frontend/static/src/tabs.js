...
(function () {
  ...
  function OverviewTab({ dash, onToggleFilter, onOpenAttention }) {
    ...
    const cat = dash.reports.service_category.slice(0, 8);
    ...
    return html`
      <div>
        ...
        <div class="grid grid-2">
          ...
          <${ChartCard} title="Service Category Split" sub="click to filter">
            <${ChartCanvas} type="doughnut" height="270px"
              ...
              onElementClick=${(label) => onToggleFilter("service_category", label)} />
          <//>
  ...
  function CasesTab({ filters, onOpenCase }) {
    ...
    const cols = ["case_number", "account_name", "subject", "priority", "service_category", "opened_date",
