...
(function () {
      ...
      <div class="upload-screen">
        <div class="upload-card">
          <div class="dropzone ${drag ? "drag" : ""}"
            ...
            <div class="icon">📊</div>
            <h3>M3M Customer Complaint MIS</h3>
            <p>${busy ? `Uploading… ${progress !== null ? progress + "%" : ""}` : "Drop your M3M workbook here, or click to browse (.xlsx / .xls)"}</p>
          ...
          <p class="text-muted" style=${{ fontSize: "11.5px", marginTop: "14px" }}>
            The workbook must contain a "Compile M3M Data" sheet — this is treated as the single source of truth. All KPIs, reports, and charts are computed dynamically from it.
          </p>
        </div>
      </div>
    `;
  ...
  function CaseDetailModal({ caseNumber, onClose }) {
    ...
    const groups = [
      ...
      { title: "Classification", fields: ["project_name", "project_unit", "service_category", "m_category"] },
