...
(function () {
  ...
  const FIELD_LABELS = {
    ...
    client_category: "Client Category (HNI)", updated_status: "Updated Status", tat_days: "TAT Days",
  ...
  const FILTER_DIM_ORDER = [
    ...
    "m_category", "area", "sub_area", "sub_category", "case_owner", "team_leader", "hod",
    "client_category", "case_source", "case_type", "escalated_label", "slab", "ia_status",
    "year", "month_name", "received_bucket", "closed_bucket",
  ];
