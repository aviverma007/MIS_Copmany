...
(function () {
  ...
  function App() {
    ...
    async function doExport(kind) {
      ...
      try {
        const map = {
          excel: ["/api/export/excel", "SW_MIS_Report.xlsx"],
          pdf: ["/api/export/pdf", "SW_MIS_Full_Report.pdf"],
          onepager: ["/api/export/pdf-onepager", "SW_MIS_Executive_OnePager.pdf"],
        };
      ...
      <div class="app-shell">
        <header class="app-header">
          <div class="brand">
            ...
            <div>
              <h1>Smartworld Customer Complaint MIS</h1>
              <div class="meta-line">
        ...
        <footer class="app-footer">Smartworld Customer Complaint MIS — runs locally, no data leaves this machine.</footer>
